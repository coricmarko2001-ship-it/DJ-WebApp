...
if (isset($_POST['login'])) {
    ...
    $select = "SELECT * FROM administrator WHERE korisnicko_ime = '$username' AND lozinka = '$pass'";
        ...
        <div class="card text-center">
            ...
            <form action="" method="post">
                ...
                <div class="divButtonContainer">
                    ...
                    <button class="btnlogin" name="register" type="button" onclick="window.location.href='adminregistracija.php'">Registracija</button>
