...
administrator – podaci o admin nalozima

korisnici – registrovani korisnici

mjesto – spisak dostupnih mjesta za rezervaciju

dogadjaji – događaji (naziv + slika + datum)

rezervacije – beleži sve rezervisane termine
